...
namespace vks 
{
	VkDeviceSize correctBufferSize(const VkPhysicalDeviceProperties& vkProperties, VkDeviceSize size)
	{
		const VkDeviceSize& nonCoherentAtomSize = vkProperties.limits.nonCoherentAtomSize;
		VkDeviceSize correctValue = size % nonCoherentAtomSize;
		// Validation(ERROR) : msg_code: 0 : [VUID - VkMappedMemoryRange - offset - 00687]  [VUID - VkMappedMemoryRange - offset - 00687]  [VUID - VkMappedMemoryRange - offset - 00687] Object : 0x23 (Type = 8) | vkFlushMappedMemoryRanges : Offset in pMemRanges[0] is 0x6f50, which is not a multiple of VkPhysicalDeviceLimits::nonCoherentAtomSize(0x80).The Vulkan spec states : offset must be a multiple of VkPhysicalDeviceLimits::nonCoherentAtomSize(https ://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VUID-VkMappedMemoryRange-offset-00687)
		// RDOC 004500 : [01:16 : 07]          vk_core.cpp(3010) - Warning - [Validation:0 / 0][VUID - VkMappedMemoryRange - offset - 00687][VUID - VkMappedMemoryRange - offset - 00687] Object : 0x23 (Type = 8) | vkFlushMappedMemoryRanges : Offset in pMemRanges[0] is 0x7460, which is not a multiple of VkPhysicalDeviceLimits::nonCoherentAtomSize(0x80).The Vulkan spec states : offset must be a multiple of VkPhysicalDeviceLimits::nonCoherentAtomSize(https ://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VUID-VkMappedMemoryRange-offset-00687)
		if (correctValue) {
			correctValue = (size + nonCoherentAtomSize - 1) / nonCoherentAtomSize;
			size = correctValue * nonCoherentAtomSize;
		}
		return size;
	}
	...
	bool UIOverlay::update()
	{
		...
		if ((vertexBuffer.buffer == VK_NULL_HANDLE) || (vertexCount != imDrawData->TotalVtxCount)) {
			...
			vertexBufferSize = correctBufferSize(device->properties, vertexBufferSize);
			indexBufferSize = correctBufferSize(device->properties, indexBufferSize);
